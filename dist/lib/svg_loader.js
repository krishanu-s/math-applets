...
export function applyPathInfo(ctx, pathInfo) {
...
export function unapplyPathInfo(ctx, pathInfo) {
 ...
 */
export async function loadSVGAndGetPoints(url) {
    // 1. Load SVG
 ...
 */
export function createSVGFileInput(onLoad) {
...
//# sourceMappingURL=svg_loader.js.map
...
export class WaveSimOneDimRust {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WaveSimOneDimRust.prototype);
        obj.__wbg_ptr = ptr;
        WaveSimOneDimRustFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
     ...
     * @param {number} width
     * @param {number} dt
     * @returns {WaveSimOneDimRust}
     */
    static new(width, dt) {
        const ret = wasm.wavesimonedimrust_new(width, dt);
        return WaveSimOneDimRust.__wrap(ret);
    }
    reset() {
